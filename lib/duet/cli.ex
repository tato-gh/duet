defmodule Duet.CLI do
  ...
  @options []
  @usage_message "Usage: duet <path-to-DUET.md | project-dir>"
  ...
  defp run(path) do
    duet_path = resolve_config_path(path)
  ...
  defp resolve_config_path(input) do
    ...
    if File.dir?(expanded), do: Path.join(expanded, "DUET.md"), else: expanded
  end
